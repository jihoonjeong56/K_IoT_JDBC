...
/*
    ...
    1) JDBC (JDBC API 기반)
        ...
        - SQL 문을 문자열로 작성
        >>  Connection, PreparedStatement, ResultSet 등의 객체를 통해 직접 통신
    ...
    2) JPA(ORM, Object Relational Mapping 기반)
        ...
        장점) SQL 작성이 거의 필요 없다, '객체 중심의 개발 가능', '유지보수가 쉽고 비즈니스 로직에 집중 가능'
    ...
    3) MyBatis (SQL Mapper 기반)
        ...
        장점 ) SQL 작서 ㅇ자유도 높음, 복잡한 쿼리 작성에 유리
        단점) SQL과 자바코드가 분리 >> 유지보수가 어렵고 중복 가능성 존재, 코드량 많음
 */
//SpringBoot 프로젝트에서 사용법
// 1. 객체 중심 설게, 유지보수가 편한 구조 : JPA
